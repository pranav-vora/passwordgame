  ...
  System.out.println("Please choose a password");
	    	 ...
	    	 continue;
	            ...
	            //Rule 2: Your password must include a number
	    		 ...
	    		 if(!Character.isDigit(index)&&!Character.isLetter(index)&&!Character.isWhitespace(index)) {
	  			...
	  			//Rule 6: Your password should include the digits to answer this math equation for x: 8x-10=1990
	  			boolean is250=false;
	           ...
	           if(is250==false) {
                	 System.out.println("Rule 6: Your password should include the digits to answer this math equation for x: 8x-10=1990");
                	 continue;
                 }
	         //Rule 7: Your password should include a Roman Numeral
	          ...
	          if(Character.isUpperCase(input.charAt(0))&&Character.isUpperCase(input.charAt(3))&&Character.isUpperCase(input.charAt(4))&&Character.isUpperCase(input.charAt(7))) {
	           ...
	           //Rule 9:Five people were eating apples, A finished before B, but behind C. D finished before E, but behind B. What was the finishing order? Your password should include the people in capital letters.
	          //CABDE
	         ...
	         //Rule 10: Your password should include exactly 10 vowels
	           int vowelCounter=0;
	           for(int i=0;i<input.length();i++) {
	           ...
	           if(vowelCounter!=10) {
	        	   System.out.println("Your password should include exactly 10 vowels");
	        	   continue;
	           }
	         //Rule 11: Your password should include exactly 7 consonants
	           ...
	           if(consonantCounter!=7) {
	        	   System.out.println("Your password should include exactly 7 consonants");
	        	   continue;
	        	   
	  		} 
	           //Rule 12: Your password should include an element from the periodic table with the first letter being capital
	           ...
	           if(haselement==false) {
	        	 System.out.println("Rule 12: Your password should include an element from the periodic table with the first letter being capital");
	        	 continue;
	           }else {
	        	   notFinished=false;
	        	   System.out.println("Congratulations! You beat the password game! Your secured password is "+ input);
	           }
	  		}        
}         
